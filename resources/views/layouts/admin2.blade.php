...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="sb-nav-fixed">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="/admin/identifikasi">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                Identifikasi
                            </a>
                            <a class="nav-link" href="/admin/edukasi">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="/admin/nutrisi">Nutrisi</a>
                                    <a class="nav-link" href="/admin/fisik">Aktivitas Fisik</a>
                                </nav>
                            </div>
                            ...
                            <a class="nav-link" href="/admin/evaluasi">
        ...
        <script src="{{ url('backend/assets/select2js/select2.min.js')}}"></script>
        <script>
